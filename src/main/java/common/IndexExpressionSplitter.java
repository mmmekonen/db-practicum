 ...
 * IndexScan and the part that cannot. This class uses the visitor pattern to
 * traverse the original expression and determines whether each subexpression
 * contains a column that has an index.
 */
public class IndexExpressionSplitter implements ExpressionVisitor {
     ...
     * expressions that can be evaluated with an index and those that can't for a
     * given table.
     * 
     ...
     * expression already exists, this function combines the two using a
     * conjunction.
     *
     ...
     * index on it, add this expression to indexConditions, otherwise, add it to
     * selectConditions.
     *
