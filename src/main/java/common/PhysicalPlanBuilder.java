...
/**
 * A class to translate a logical operators into a relational algebra query
 * plan using physical operators. This class uses the visitor pattern to
 * traverse the logical query plan and replaces each logical operator with its
 * corresponding physical operator. The physical operators used depends on the
...
public class PhysicalPlanBuilder {
     ...
     * in-memory sort or an external sort.
     * 
