...
public class QueryPlanBuilder {
  ...
  public LogicalOperator logicalPlan(Statement stmt) {
    ...
    if (where != null)
      conditions = new SelectUF(where);
    // System.out.println(conditions);

    // make logical query plan
    LogicalOperator rootOperator;
    if (joins == null)
      rootOperator = selectHelper(table, conditions);
    else
      rootOperator = joinHelper(table, joins, where, conditions);
  ...
  private LogicalOperator joinHelper(
    ...
    for (Join j : joins)
      children.add(selectHelper((Table) j.getRightItem(), conditions));
  ...
  /**
   * A method to create the string representation of the logical plan
   * corresponding with a statement
   *
  ...
  /**
   * A method to create the string representation of the physical plan
