 ...
 * to an outputSchema
 * which represents the schema of the output tuples from the operator. This is a
 * list of Column
 * objects. Each Column has an embedded Table object with the name and alias (if
 * required) fields
 * set appropriately.
 */
