...
/**
 * A class to represent a sort operator on a relation. Sorts each tuple in the order of columns in
 * orderbyElements and then in the order of the remaining columns in it's child operator's
 * outputSchema.
 */
