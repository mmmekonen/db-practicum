...
public class ExpressionSorter implements ExpressionVisitor {
  ...
  public String getTableName() {
    if (onSingleTable()) {
      String name =
          latestTable.getAlias() != null ? latestTable.getAlias().getName() : latestTable.getName();
      return name;
    } else return null;
  }
  ...
  public void visit(Column tableColumn) {
    Table t = tableColumn.getTable();
    String name = t.getAlias() != null ? t.getAlias().getName() : t.getName();
    tables.add(name);
