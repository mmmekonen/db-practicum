...
public class ExpressionSplitter implements ExpressionVisitor {
   ...
   */
  public Expression getConditions(String t) {
  ...
  public void visit(EqualsTo equalsTo) {
    ...
    if (visitor.onSingleTable()) concatHelper(equalsTo, visitor.getTableName());
  }
  ...
  public void visit(NotEqualsTo notEqualsTo) {
    ...
    if (visitor.onSingleTable()) concatHelper(notEqualsTo, visitor.getTableName());
  }
  ...
  public void visit(GreaterThan greaterThan) {
    ...
    if (visitor.onSingleTable()) concatHelper(greaterThan, visitor.getTableName());
  }
  ...
  public void visit(GreaterThanEquals greaterThanEquals) {
    ...
    if (visitor.onSingleTable()) concatHelper(greaterThanEquals, visitor.getTableName());
  }
  ...
  public void visit(MinorThan minorThan) {
    ...
    if (visitor.onSingleTable()) concatHelper(minorThan, visitor.getTableName());
  }
  ...
  public void visit(MinorThanEquals minorThanEquals) {
    ...
    if (visitor.onSingleTable()) concatHelper(minorThanEquals, visitor.getTableName());
  }
