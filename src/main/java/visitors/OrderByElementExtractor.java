...
public class OrderByElementExtractor implements ExpressionVisitor {
   ...
   *
   * @param schema the schema of the table is referenced by the statement this
   *               visitor operates on
   */
  ...
  /**
   * Function to get the index of a column, given its name, by iterating over the
   * volumns and
   * checking each one
   *
  ...
  /**
   * Helper function to create a conjunction a sub-expression and the expression
   * held in the visitor
   *
